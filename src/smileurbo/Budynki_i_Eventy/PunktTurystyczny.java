 ...
 * @author katan
 */
public class PunktTurystyczny extends Budynek{
    private Wielkosc wielkosc;
    
    public static final String NAZWA = "Punkt turystyczny";
    ...
    public PunktTurystyczny() {
        
    }
    
    public PunktTurystyczny(Wielkosc wielkosc) {
