 ...
 * @author katan
 */
public class ZakazSportowWodnychNaJeziorze extends Eventy{
    
    public static final String NAZWA = "Zakaz Sportów Wodnych na Jeziorze";
    ...
    public ZakazSportowWodnychNaJeziorze() {
