 ...
 * @author katan
 */
public class OrganizacjaWiejskichDozynek extends Eventy{
    public static final String NAZWA = "Organizacja wiejskich dożynek";
    ...
    public OrganizacjaWiejskichDozynek() {
