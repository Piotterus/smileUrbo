 ...
 * @author katan
 */
public class PoleGolfowe extends Budynek{
    
    private Wielkosc wielkosc;
    
    public static final String NAZWA = "Pole golfowe";
    ...
    public static final int PODSTMODYFIKATOR_KOSZTOWZYCIA = 3;
    ...
    public PoleGolfowe(Wielkosc wielkosc) {
