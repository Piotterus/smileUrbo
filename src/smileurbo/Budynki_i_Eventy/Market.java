 ...
 * @author katan
 */
public class Market extends Budynek{
    
    private Wielkosc wielkosc;
    
    public static final String NAZWA = "Market";
        
    public static final int PODSTMODYFIKATOR_POZIOMUBEZROBOCIA = -4;
    public static final int PODSTMODYFIKATOR_POZIOMUZANIECZYSZCZEN = 4;
    ...
    public static final int PODSTMODYFIKATOR_NIEZALEZNOSCIZYWIENIOWEJ = 2;
    ...
    public Market(Wielkosc wielkosc) {
