...
public class Hotel extends Budynek{
    ...
    public static final String NAZWA = "Hotel";
    
    public static final int PODSTMODYFIKATOR_POZIOMUBEZROBOCIA = -5;
    public static final int PODSTMODYFIKATOR_POZIOMUZANIECZYSZCZEN = 3;
    ...
    public static final int PODSTMODYFIKATOR_KOSZTOWZYCIA = 0;
    public static final int PODSTMODYFIKATOR_NIEZALEZNOSCIZYWIENIOWEJ = 0;
    
    public static final int KOSZTBUDOWYDUZEGO = 30000;
    public static final int KOSZTBUDOWYSREDNIEGO = 20000;
    public static final int KOSZTBUDOWYMALEGO = 10000;
    ...
    public Hotel(Wielkosc wielkosc) {
